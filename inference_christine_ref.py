...
if __name__ == "__main__":
    result = run_inference(
        ...
        model_path="results_christine2_no_mz/fm_biomech_model_best.pth",
        scalers_path="results_christine2_no_mz/scalers_concat.json",
        variant="improved",
        solver="euler",
        n_steps=20,
        n_seeds=3,
        data_root="DATA/christine_ref_npy",
        output_dir="results_christine2_ref_no_mz",
