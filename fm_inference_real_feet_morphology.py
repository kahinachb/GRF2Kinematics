...
def parse_arguments():
    ...
    parser.add_argument("--model", default="results_real_feet_morphology/fm_morphology_model_best_ema.pth")
    parser.add_argument("--scalers", default="results_real_feet_morphology/scalers_morphology.json")
    parser.add_argument("--data-root", default=None, help="Defaults to DATA_ROOT from the training script.")
    parser.add_argument("--output-dir", default="results_real_feet_morphology")
