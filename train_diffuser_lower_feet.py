...
def run_experiment():
    ...
    data_root = Path("/lustre/fsn1/projects/rech/vsi/ulm94jm/dataset_grf2kine/npy_synth")
    ...
    if len(task_subs) == 0:
        ...
        n = len(subjects)
        train_subs = subjects[:int(0.7*n)]
        val_subs   = subjects[int(0.7*n):int(0.85*n)]
        test_subs  = subjects[int(0.85*n):]
