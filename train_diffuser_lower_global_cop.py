...
def run_experiment():
    ...
    data_root = Path("/lustre/fsn1/projects/rech/vsi/ulm94jm/dataset_grf2kine/processed_data_global")

    results_dir = Path("results_global_cop")
    ...
    def get_pairs(subs):
        ...
        for s in subs:
            ...
            for t in s.iterdir():
                if t.is_dir():
                    f = t / "kinetics_glob.npy"  # On cible uniquement le 100Hz
                    j = t / "all_joints.npy"
